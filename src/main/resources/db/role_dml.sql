...
INSERT INTO `sys_menu` ( parent_id, name, url, perms, `type`, icon, order_no, create_time, update_time, status)
    VALUES ('1', '角色', 'modules/generator/${pathName}.html', NULL, '1', 'fa fa-file-code-o', '6');
VALUES(1, '角色', 'sys/role', 'sys:role:role', 1, 'fa fa-user-secret', 12, '2019-01-01 00:00:00.000', NULL, '1');
