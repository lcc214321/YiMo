...
public class UserDO extends BaseDO {
	...
	private Long userId;
	// 用户名
	@Excel(name = "登录账号", orderNum = 0, type = Type.ALL)
	private String userName;
	// 昵称
	@Excel(name = "姓名", orderNum = 1, type = Type.ALL)
	private String name;
	// 密码
	...
	// 邮箱
	@Excel(name = "邮箱", orderNum = 2, type = Type.ALL)
	...
	// 状态 0:禁用，1:正常
	@Excel(name = "状态", orderNum = 8, convertExp = "Status", comboExp = "Status")
