package cn.tayle.common.aspect;
...
import cn.tayle.common.util.WebUtils;
import cn.tayle.sys.domain.LogDO;
import cn.tayle.sys.domain.UserDO;
import cn.tayle.sys.service.LogService;
...
public class LogAspect {
	 ...
	 * @return void
	 */
	@Pointcut("@annotation(cn.tayle.common.annotation.Log)")
