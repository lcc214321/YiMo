...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=752 DEFAULT CHARSET=utf8 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_online` VALUES ('72db1a2d-9431-41db-b6af-a94f1abc7193',1,'tayle',2,'科技部','127.0.0.1','未知地址','Chrome','Windows 10','on_line','2019-03-19 12:15:44',NULL,NULL),('823708c7-a0ef-493b-87ca-7aaa3898b5c7',1,'tayle',2,'科技部','127.0.0.1','未知地址','Chrome','Windows 10','on_line','2019-03-19 12:14:59',NULL,NULL),('a976f1d9-ede3-46c4-aa5d-d878554fa72c',1,'tayle',2,'科技部','127.0.0.1','未知地址','Chrome','Windows 10','on_line','2019-03-19 12:15:25',NULL,NULL);
