...
INSERT INTO `sys_job` VALUES (4,'SyncOnlineStatusJob','myCronJob','top.yimo.common.quartz.job.SyncOnlineStatusJob','','0 0/10 * * * ?','1','0','1','2019-03-26 11:07:19','0','2019-03-27 15:08:17','','同步在线用户状态');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1584 DEFAULT CHARSET=utf8 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_menu` VALUES (1,0,'系统管理','','',0,'fa fa-gears',10,'2017-08-09 22:49:47','2019-03-27 16:19:56','1'),(2,1,'系统菜单','sys/menu/','sys:menu:menu',1,'fa fa-th-list',13,'2017-08-09 22:55:15','2019-03-27 16:21:32','1'),(3,1,'部门管理','sys/dept/','sys:dept:dept',1,'fa fa-group',14,'2017-08-09 22:55:15','2019-03-27 16:21:35','1'),(4,1,'用户管理','sys/user/','sys:user:user',1,'fa fa-user',11,'2017-08-10 14:12:11','2019-03-27 16:21:24','1'),(5,1,'角色管理','sys/role','sys:role:role',1,'fa fa-user-secret',12,'2017-08-10 14:13:19','2019-03-27 16:21:28','1'),(6,4,'编辑','','sys:user:edit',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(7,4,'新增','','sys:user:add',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(8,4,'删除','','sys:user:remove',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(9,4,'重置密码','','sys:user:resetPwd',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(10,4,'批量删除','','sys:user:batchRemove',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(11,2,'新增','sys/menu/','sys:menu:add',2,'',3,'2017-08-09 22:55:15',NULL,'1'),(12,2,'编辑','sys/menu/','sys:menu:edit',2,'',3,'2017-08-09 22:55:15',NULL,'1'),(13,2,'删除','sys/menu/','sys:menu:remove',2,'',3,'2017-08-09 22:55:15',NULL,'1'),(17,5,'编辑','','sys:role:edit',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(18,5,'删除','','sys:role:remove',2,'',0,'2017-08-14 10:51:35',NULL,'1'),(25,3,'新增','','sys:dept:add',2,'',NULL,NULL,NULL,'1'),(26,3,'编辑','','sys:dept:edit',2,'',NULL,NULL,NULL,'1'),(32,3,'删除','','sys:dept:remove',2,'',NULL,NULL,NULL,'1'),(37,0,'系统工具','','',0,'fa fa-cog fa-spin',20,'2019-03-01 14:16:05','2019-03-27 16:19:49','1'),(38,37,'自动生成代码','generator','sys:generator:generator',1,'fa fa-anchor ',20,'2019-03-01 14:22:52','2019-03-27 16:19:41','1'),(39,0,'系统监控','','',0,'fa fa-tachometer',22,'2019-03-01 18:09:57','2019-03-27 16:21:14','1'),(40,39,'系统日志','sys/log','sys:log:log',1,'fa fa-file-archive-o',31,'2019-03-01 18:11:48','2019-03-27 16:20:52','1'),(41,5,'新增','','sys:role:add',2,'',NULL,'2019-03-05 11:53:48',NULL,'1'),(42,1,'数据字典','sys/dict','sys:dict:dict',1,'fa fa-book',15,'2019-03-07 17:26:16','2019-03-27 16:21:39','1'),(43,42,'新增','','sys:dict:add',2,'',NULL,'2019-03-07 17:35:45',NULL,'1'),(44,42,'编辑','','sys:dict:edit',2,'',NULL,'2019-03-07 17:36:08',NULL,'1'),(45,42,'删除','','sys:dict:remove',2,'',NULL,'2019-03-07 17:36:08',NULL,'1'),(46,42,'数据字典数据','','sys:dictData',2,'',NULL,'2019-03-07 17:36:08',NULL,'1'),(47,42,'编辑字典数据','','sys:dictData:edit',2,'',NULL,'2019-03-07 17:36:08',NULL,'1'),(48,42,'新增字典数据','','sys:dictData:add',2,'',NULL,'2019-03-07 17:36:08',NULL,'1'),(49,42,'删除字典数据','','sys:dictData:remove',2,'',NULL,'2019-03-07 17:36:08',NULL,'1'),(50,39,'在线用户','sys/userOnline','sys:userOnline:userOnline',1,'fa fa-user',32,'2019-03-18 15:16:35','2019-03-27 16:20:58','1'),(51,50,'强制提出','','sys:userOnline:kickout',2,'',NULL,'2019-03-18 15:29:08',NULL,'1'),(53,39,'定时任务管理','sys/job','sys:job:job',1,'fa fa-calendar',33,'2019-03-25 17:00:14','2019-03-27 16:21:02','1'),(54,37,'表单构建器','tool/frombuild','tool:frombuild',1,'fa fa-arrows',21,'2019-03-27 16:19:30','2019-03-27 16:21:09','1');
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','superAdmin','',NULL,NULL,'2019-03-27 16:21:57','1'),(2,'用户管理员','userAdmin','用于管理用户信息',NULL,NULL,NULL,'1'),(3,'系统运维员','operations','',NULL,NULL,'2019-03-05 12:04:14','1');
...
) ENGINE=InnoDB AUTO_INCREMENT=404 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
/*!40101 SET character_set_client = @saved_cs_client */;
